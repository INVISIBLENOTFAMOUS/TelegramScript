/*SUBSCRIBE MY YOUTUBE YUDAMODS YT*/
...
exports.first_chat = (botname, pushname) => {
    return `Halo bang ${pushname}! Nama saya ${botname} - Saya adalah Bot Telegram multi fungsi! Klik /menu untuk mengetahui lebih lanjut tentang cara menggunakan bot ini.`
}
...
exports.wait = "`⏳ © 𝙔𝙪𝙙𝙖𝙈𝙤𝙙𝙨 𝘿𝙚𝙫 𖤍.`"
exports.ok = "`© 𝙔𝙪𝙙𝙖𝙈𝙤𝙙𝙨 𝘿𝙚𝙫 𖤍. Done ✅`"
...
├ Sponsored :  [@YUDAMODSZX](https://t.me/YUDAMODSZX)
├ Prefix :   ${prefix}
├ Total hit : ${hitall}
...
╭─❒ 「 TqTo 」 
├ YudaMods dev : [@YUDAMODSZX](https://t.me/YUDAMODSZX)
├ Team Xbot 
╰❒ Menu ini di tambah kan oleh YudaMods devོ
